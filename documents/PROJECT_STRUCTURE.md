...
│   ├── NUTRITION_RECALCULATION.md  # Система автоматического пересчета питательности программ
...
│   # Примечание: тестовые данные в .bak файлах
│
├── public/                         # Статические файлы
│   ├── uploads/                    # Загруженные изображения блюд (сейчас хранятся на Tilda)
│   └── web/                        # Файлы для размещения на Тильде
│
